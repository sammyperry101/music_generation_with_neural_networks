...
# Class which controls the multi-head attention for the note timings
class TimingsMultiheadAttention(nn.Module):
    def __init__(
        self,
        embedding_size: int,
        sequence_length: int,
    ...
    def forward(self, x: np.array):
        ...
        # Divie the input into different dimesions for each head
